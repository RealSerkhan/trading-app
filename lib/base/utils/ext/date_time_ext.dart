...
extension NullableDateTimeExt on DateTime? {
  ...
  String get asDays =>
      this == null ? '' : this!.difference(DateTime.now()).inDays.toString();

  String get todMy => this == null ? '' : DateFormat('d/M/y').format(this!);
}
