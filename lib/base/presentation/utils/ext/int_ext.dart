...
import 'package:responsiveness/responsiveness.dart' as responsiveness;
...
extension IntNullableExt on num? {
  ...
  SliverPadding get sliverHeight =>
      SliverPadding(padding: EdgeInsets.only(bottom: (this ?? 0).h));
  SliverPadding get sliverWidth =>
      SliverPadding(padding: EdgeInsets.only(right: (this ?? 0).w));
}
